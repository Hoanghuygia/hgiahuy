...
// model experience
{
    const btn = document.querySelector(".js-experience-button");
    const modal = document.querySelector(".js-modal-exprience");
    const modalClose = document.querySelectorAll(".js-close-experience");
    const modalContainer = document.querySelector(".js-modal-container-exprience");
...
//modal project
document
    .querySelectorAll(".js-modal-open-project")
...
document.querySelectorAll(".js-close-project").forEach(function (btn) {
    btn.addEventListener("click", function () {
        let classNames = Array.from(btn.classList);
        let className = classNames[classNames.length - 1];
        let modalRemoved = document.querySelector(
            ".modal-project" + "." + className
        );
...
document
    .querySelectorAll(".js-modal-container-project")
